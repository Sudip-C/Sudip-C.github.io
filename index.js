...
function download() {
	...
	link.href = "Sudip Chowdhury-Full Stack Web Developer.pdf";
	link.download = "Sudip Chowdhury-Full Stack Web Developer.pdf";
	link.click();
	link.remove();
}

function redirect() {
	window.open("Sudip Chowdhury-Full Stack Web Developer.pdf");
}
